...
namespace TripleEngineCore {
    ...
    const std::string& TripleEngineCore::OpenGLRenderModule::getName() const
    {
        return this->_name;
    }
    ...
    bool TripleEngineCore::OpenGLRenderModule::load()
    {
        ...
        if (!this->_data.libHandle) {
            TripleLogger::TLogger::ModuleError(this->_name, "Failed to load OpenGL module: \"{}\"", this->_path);
			return false;
        }
        ...
        if (!this->_data.createFunc) {
			TripleLogger::TLogger::ModuleError(this->_name, "Failed to find CreateRenderer function in OpenGL module: \"{}\"", this->_path);
            this->unload();
            return false;
        }
        ...
        if (!this->_data.destroyFunc) {
            TripleLogger::TLogger::ModuleError(this->_name, "Failed to find DestroyRenderer function in OpenGL module: \"{}\"", this->_path);
            this->unload();
            return false;
        }
		...
		if (!this->_data.renderer) {
			TripleLogger::TLogger::ModuleError(this->_name, "Failed to create OpenGL renderer from module: \"{}\"", this->_path);
            this->unload();
			return false;
		}
		TripleLogger::TLogger::ModuleInfo(this->_name, "OpenGL module loaded successfully: \"{}\"", this->_path);
		return true;
    }
    ...
    void OpenGLRenderModule::unload()
    {
		...
		if (this->_data.libHandle) {
            ...
            TripleLogger::TLogger::ModuleWarn(this->_name, "OpenGL module unloaded: \"{}\"", this->_path);
		}
    }
