...
namespace triple::core {
	OpenGLRenderModule::OpenGLRenderModule(const std::string &modulesPath,
	...
	const std::string &OpenGLRenderModule::getModuleName() const { return this->m_name; }
	...
	gfx::IRenderer *OpenGLRenderModule::getRenderer() const { return this->m_data.renderer; }

	std::string OpenGLRenderModule::getModuleClassName() { return "OpenGLRenderModule"; }

	OpenGLRenderModule::~OpenGLRenderModule() { this->unload(); }
} // namespace triple::core
